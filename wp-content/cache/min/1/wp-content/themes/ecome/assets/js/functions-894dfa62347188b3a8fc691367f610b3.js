(function ($, window, document, undefined) {
    ...
    $.each(_elements, function (key, item) {
      ...
      if ($this.parent('[data-vc-full-width="true"]').length > 0) {
        ...
        if (this_child.length > 0) {
          ...
          $this.css({ left: "auto", right: this_left });
        }
      }
    }),
      ...
      .on("ecom_sticky_menu", function () {
        $this.each(function () {
          ...
          if ($(this).find(".verticalmenu-content").length > 0)
            headerOrgOffset =
              headerOrgOffset +
              $(this).find(".verticalmenu-content").outerHeight();
          if ($(window).width() > 1024) {
  ...
  $.fn.ecome_animation_tabs = function (_tab_animated) {
    $(this)
      .on("ecome_animation_tabs", function () {
        _tab_animated =
          _tab_animated == undefined || _tab_animated == ""
            ? ""
            : _tab_animated;
        if (_tab_animated == "") {
          return;
        ...
        $(this)
          .find(".owl-slick .slick-active, .product-list-grid .product-item")
          .each(function (i) {
            var _this = $(this),
            ...
            _this
              ...
              .addClass(_tab_animated + " animated")
              .one(
  ...
  $.fn.ecome_init_carousel = function () {
    $(this)
      .on("ecome_init_carousel", function () {
        $(this)
  ...
  $.fn.ecome_product_thumb = function () {
    $(this)
      .on("ecome_product_thumb", function () {
        $(this)
          .not(".slick-initialized")
          .each(function () {
            var _this = $(this),
  ...
  $.fn.ecome_countdown = function () {
    $(this)
      .on("ecome_countdown", function () {
        $(this).each(function () {
          var _this = $(this),
            _text_countdown = "";
          _this.countdown(_this.data("datetime"), function (event) {
            _text_countdown = event.strftime(
              '<span class="days"><span class="number">%D</span><span class="text">' +
                ecome_global_frontend.countdown_day +
                "</span></span>" +
                '<span class="hour"><span class="number">%H</span><span class="text">' +
                ecome_global_frontend.countdown_hrs +
                "</span></span>" +
                '<span class="mins"><span class="number">%M</span><span class="text">' +
                ecome_global_frontend.countdown_mins +
                "</span></span>" +
                '<span class="secs"><span class="number">%S</span><span class="text">' +
                ecome_global_frontend.countdown_secs +
                "</span></span>"
            );
  ...
  $.fn.ecome_alert_variable_product = function () {
    $(this)
      .on("ecome_alert_variable_product", function () {
  ...
  if ($(window).width() < 991) {
    $(".block-minicart").removeClass("ecome-dropdown");
    // $(".block-user").removeClass("ecome-dropdown");
  } else {
    // $(".block-user").addClass("ecome-dropdown");
  }
  ...
  $.fn.ecome_better_equal_elems = function () {
    var _this = $(this);
    _this
      .on("ecome_better_equal_elems", function () {
        _this.each(function () {
  ...
  $(document).on(
    "click",
    ".ecome-tabs .tab-link a, .ecome-accordion .panel-heading a",
    function (e) {
      e.preventDefault();
      var _this = $(this),
        _ID = _this.data("id"),
        ...
        _loaded = _this
          .closest(".tab-link,.ecome-accordion")
          .find("a.loaded")
          .attr("href");
      if (_ajax_tabs == 1 && !_this.hasClass("loaded")) {
        $(_tabID)
          .closest(".tab-container,.ecome-accordion")
          .addClass("loading");
        ...
        $.ajax({
          ...
          success: function (response) {
            if (response.success == "ok") {
              $(_tabID).html(
                $(response.html).find(".vc_tta-panel-body").html()
              );
              $(_tabID)
                .closest(".tab-container,.ecome-accordion")
                .removeClass("loading");
  ...
  $.fn.ecome_hover_product_item = function () {
    var _this = $(this);
    _this
      .on("ecome_hover_product_item", function () {
        _this.each(function () {
  ...
  $.fn.ecome_show_all_product_desc = function () {
    ...
    if (_height > 800) {
      ...
      $("#tab-description").append(
        '<button class="show-all"><i class="text">Show more</i></span><span class="fa fa-angle-down"></span></button>'
      );
    }
  ...
  $.fn.ecome_google_map = function () {
    ...
    _this.each(function () {
      var $id = $(this).data("id"),
        ...
        $saturation = "",
        $modify_coloring = !1,
        $coinpo_map = { lat: $latitude, lng: $longitude };
      if ($modify_coloring === !0) {
        var $styles = [
          {
            stylers: [
              { hue: $hue },
      ...
      var contentString =
        '<div style="background-color:#fff; padding: 30px 30px 10px 25px; width:290px;line-height: 22px" class="coinpo-map-info">' +
        '<h4 class="map-title">' +
        $title +
        "</h4>" +
        ...
        $address +
        "</span></div>" +
        '<div class="map-field"><i class="fa fa-phone"></i><span>&nbsp;<a href="tel:' +
        $phone +
        '">' +
        $phone +
        "</a></span></div>" +
      ...
      var marker = new google.maps.Marker({ position: $coinpo_map, map: map });
  ...
  $(document).on("click", ".remove_from_cart_button", function () {
    ...
    ecome_setCookie(
      "undo_cart_link",
      ecome_ajax_frontend.wp_nonce_url + "&undo_item=" + cart_item_key,
      1
    );
  });
  ...
  $body.on("added_to_cart", function () {
    var config = [];
    config.title = ecome_ajax_frontend.growl_notice_text;
    $(".add_to_cart_button.product_type_variable.isw-ready").removeClass(
      "loading"
    );
    var $recentAdded = $(
        ".add_to_cart_button.recent-added, button.single_add_to_cart_button.recent-added"
      ),
    ...
    if (typeof pName !== "undefined") {
      config.message =
        ...
        pName +
        '"' +
        ecome_ajax_frontend.added_to_cart_notification_text +
        '&nbsp;<a href="' +
        ecome_ajax_frontend.wc_cart_url +
        '">' +
        ecome_ajax_frontend.view_cart_notification_text +
        "</a></p>";
    } else {
      config.message =
        ecome_ajax_frontend.added_to_cart_text +
        '&nbsp;<a href="' +
        ecome_ajax_frontend.wc_cart_url +
        '">' +
        ecome_ajax_frontend.view_cart_notification_text +
  ...
  $body.on("added_to_wishlist", function () {
    ...
    config.message =
      '<p class="growl-content">' +
      ecome_ajax_frontend.added_to_wishlist_text +
      '&nbsp;<a href="' +
      ecome_ajax_frontend.wishlist_url +
      '">' +
      ecome_ajax_frontend.browse_wishlist_text +
      "</a></p>";
    $.growl.notice(config);
  });
  function ecome_popover_button() {
    $('[data-toggle="tooltip"]').tooltip();
    $(".product-item .group-button a,.product-item .yith-wcqv-button").each(
      function () {
    ...
    if (_popup != null) {
      ...
      if (disabled_popup_by_user == "true") {
        ...
        if (ecome_global_frontend.ecome_enable_popup == 1) {
          setTimeout(function () {
            $(_popup).modal({ keyboard: !1 });
            $(_popup).find(".lazy").lazy({ delay: 0 });
  ...
  function ecome_block_align_full() {
    ...
    $container.each(function () {
      ...
      var $alignFullElem = $this.find(
        ".alignfull:not(.wp-block-columns):not(.wp-block-image):not(.wp-block-cover):not(.wp-block-gallery):not(.wp-block-embed-wordpress-tv)"
      );
      $alignFullElem.css({
        position: "relative",
        left: "-" + this_left + "px",
  ...
  $(document).ready(function () {
    ...
    $(document).on(
      "click",
      ".ecome-single-add-to-cart-fixed-top",
      function (e) {
        var $this = $(this);
        if ($(".product .summary button.single_add_to_cart_button").length) {
          $(".product .summary button.single_add_to_cart_button").trigger(
            "click"
          );
        }
        e.preventDefault();
